...
struct Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_MPTestingCharacter_h__Script_MPTesting_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMPTestingCharacter, AMPTestingCharacter::StaticClass, TEXT("AMPTestingCharacter"), &Z_Registration_Info_UClass_AMPTestingCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMPTestingCharacter), 2020520503U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_MPTestingCharacter_h__Script_MPTesting_65331697(TEXT("/Script/MPTesting"),
