...
MPTESTING_API UClass* Z_Construct_UClass_ACombatEnemySpawner();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 2920025976
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_Variant_Combat_AI_CombatEnemySpawner_h__Script_MPTesting_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 2671907066U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_Variant_Combat_AI_CombatEnemySpawner_h__Script_MPTesting_364287957(TEXT("/Script/MPTesting"),
	Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_Variant_Combat_AI_CombatEnemySpawner_h__Script_MPTesting_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Multiplayer_Project_Source_MPTesting_Variant_Combat_AI_CombatEnemySpawner_h__Script_MPTesting_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
