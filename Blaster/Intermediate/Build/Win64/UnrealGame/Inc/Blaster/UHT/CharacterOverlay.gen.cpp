...
struct Z_Construct_UClass_UCharacterOverlay_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_GrenadesText_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/HUD/CharacterOverlay.h" },
	};
...
struct Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_CharacterOverlay_h__Script_Blaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCharacterOverlay, UCharacterOverlay::StaticClass, TEXT("UCharacterOverlay"), &Z_Registration_Info_UClass_UCharacterOverlay, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCharacterOverlay), 4035298718U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_CharacterOverlay_h__Script_Blaster_3222973441(TEXT("/Script/Blaster"),
