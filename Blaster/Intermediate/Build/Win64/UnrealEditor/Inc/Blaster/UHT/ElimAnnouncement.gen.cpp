...
FClassRegistrationInfo Z_Registration_Info_UClass_UElimAnnouncement;
UClass* UElimAnnouncement::GetPrivateStaticClass()
{
	using TClass = UElimAnnouncement;
	if (!Z_Registration_Info_UClass_UElimAnnouncement.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("ElimAnnouncement"),
			Z_Registration_Info_UClass_UElimAnnouncement.InnerSingleton,
			StaticRegisterNativesUElimAnnouncement,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UElimAnnouncement.InnerSingleton;
}
UClass* Z_Construct_UClass_UElimAnnouncement_NoRegister()
{
	return UElimAnnouncement::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UElimAnnouncement_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/HUD/ElimAnnouncement.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AnnouncementBox_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/HUD/ElimAnnouncement.h" },
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_ElimAnnouncement_h__Script_Blaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UElimAnnouncement, UElimAnnouncement::StaticClass, TEXT("UElimAnnouncement"), &Z_Registration_Info_UClass_UElimAnnouncement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UElimAnnouncement), 2261018163U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_ElimAnnouncement_h__Script_Blaster_4097658060(TEXT("/Script/Blaster"),
	Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_ElimAnnouncement_h__Script_Blaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_HUD_ElimAnnouncement_h__Script_Blaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
