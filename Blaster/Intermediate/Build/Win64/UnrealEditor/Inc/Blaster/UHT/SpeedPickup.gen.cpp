...
FClassRegistrationInfo Z_Registration_Info_UClass_ASpeedPickup;
UClass* ASpeedPickup::GetPrivateStaticClass()
{
	using TClass = ASpeedPickup;
	if (!Z_Registration_Info_UClass_ASpeedPickup.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("SpeedPickup"),
			Z_Registration_Info_UClass_ASpeedPickup.InnerSingleton,
			StaticRegisterNativesASpeedPickup,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_ASpeedPickup.InnerSingleton;
}
UClass* Z_Construct_UClass_ASpeedPickup_NoRegister()
{
	return ASpeedPickup::GetPrivateStaticClass();
}
struct Z_Construct_UClass_ASpeedPickup_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Pickups/SpeedPickup.h" },
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_Pickups_SpeedPickup_h__Script_Blaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASpeedPickup, ASpeedPickup::StaticClass, TEXT("ASpeedPickup"), &Z_Registration_Info_UClass_ASpeedPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpeedPickup), 1054276529U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_Pickups_SpeedPickup_h__Script_Blaster_180723685(TEXT("/Script/Blaster"),
	Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_Pickups_SpeedPickup_h__Script_Blaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Blaster_Source_Blaster_Public_Pickups_SpeedPickup_h__Script_Blaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
